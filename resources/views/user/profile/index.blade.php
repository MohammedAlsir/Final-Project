...
<form method="POST" class="m-form m-form--fit m-form--label-align-right" action ="{{ route('profile_update_user',$user->id) }}" data-parsley-validate enctype="multipart/form-data">
