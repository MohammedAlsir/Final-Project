...
@section('sub_titel')
<script type="text/javascript" src="{{ URL::asset('assets/chars/counterchar.js') }}"></script>
@endsection
@section('sub_titel')
    ...
    <div class="m-portlet m-portlet--tabs">
                                ...
                                <div class="m-dropdown__body">
                                    <div class="m-dropdown__content">
                                        <ul class="m-nav">
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_counters2',$type='Today')}}" >
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_counters2',$type='Yesterday')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Yesterday
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_counters2',$type='Last 7 Days')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last 7 Days
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link" href="{{route('report_counters2',$type='Last 30 Days')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last 30 Days
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link" href="{{route('report_counters2',$type='This Month')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        This Month
                                                    </span>
                                            ...
                                            <li class="m-nav__item ">
                                                <a class="m-nav__link" href="{{route('report_counters2',$type='Year')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last Year
                                                    </span>
                                        ...
                                        <ul class="m-nav">
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_counters')}}">
                                                    <i class="m-nav__link-icon flaticon-share" style="color: #716aca"></i>
        ...
        <div class="m-portlet__body">
            ...
            <span class="m--font-danger">
                <b>Note</b> This Reports For Counters 
            ...
            @else
            <span class="m--font-danger">
                <b>Note</b> This Reports For All Counters 
                <br>
            </span>
            @endif 
                                    ...
                                    <div class="m-widget16">
                                        <div class="row">
                                                        ...
                                                        <div class="m-widget16__item">
                                                            ...
                                                            <span class="m-widget16__price m--align-right m--font-brand">
                                                                ...
                                                                @else
                                                                    ...
                                                                    @else
                                                                        @if($from==1 && $to==1)
                                                                        {{ROUND($sector->counters()->count()*100/$counters->count(),2)}}%<br>
                                                                        @else
                                                                        {{ROUND($sector->counters()->whereDate('created_at','>=',$from)->whereDate('created_at','<=',$to)->count()*100/$counters->count(),2)}}%<br>
                                                                        @endif
                                                                    @endif
                                                                    {{-- @else
                                            ...
                                            <div class="col-md-6">
                                                @foreach ($sectors as $sector)
                                                @php
                                                     $namesjs []= $sector->sector_type;
                                                     if($from==1 && $to==1){
                                                        $countersjs []= $sector->counters()->count();
                                                     }else{
                                                ...
                                                <script>
                                                    ...
                                                    var $countersjs = {!! json_encode($countersjs) !!};
                                                    
                                                </script>
                                                   
                                                <canvas id="counters"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="m_daterangepicker_modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form  action="{{route('report_counters2',$type='rang')}}"  class="m-form m-form--fit m-form--label-align-right">
