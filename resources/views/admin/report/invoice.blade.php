...
@section('sub_titel')
<script type="text/javascript" src="{{ URL::asset('assets/chars/invoice.js') }}"></script>
@endsection
                                ...
                                <div class="m-dropdown__body">
                                    <div class="m-dropdown__content">
                                        <ul class="m-nav">
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_invoices2',$type='Today')}}" >
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_invoices2',$type='Yesterday')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Yesterday
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_invoices2',$type='Last 7 Days')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last 7 Days
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link" href="{{route('report_invoices2',$type='Last 30 Days')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last 30 Days
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link" href="{{route('report_invoices2',$type='This Month')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        This Month
                                                    </span>
                                            ...
                                            <li class="m-nav__item ">
                                                <a class="m-nav__link" href="{{route('report_invoices2',$type='Year')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last Year
                                                    </span>
                                        ...
                                        <ul class="m-nav">
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_invoices')}}">
                                                    <i class="m-nav__link-icon flaticon-notes" style="color: #716aca"></i>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="m-widget16__body">
                                                    ...
                                                    <div class="m-widget16__item">
                                                        <span class="m-widget16__date">
                                                            Total Electrics Quantity
                                                        </span>
                                                        <span class="m-widget16__price m--align-right m--font-brand">  
                                                            {{$invoices->sum('electrics_quantity')}} 
                                                        </span>
                                                    </div>
                                                    <!--end::widget item-->	
                                                    <div class="m-widget16__item">
                                ...
                                <table class="m-datatable" id="html_table" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($invoices as $invoice)
                                            ...
                                            <td>
                                                {{$invoice->counter->counter_number}}
                                        </td>
                                            <td>
                                                    {{$invoice->amount}}
                                            </td>
...
<div class="modal fade" id="m_daterangepicker_modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form  action="{{route('report_invoices2',$type='rang')}}"  class="m-form m-form--fit m-form--label-align-right">
