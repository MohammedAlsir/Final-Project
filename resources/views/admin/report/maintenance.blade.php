...
@section('sub_titel')
<script type="text/javascript" src="{{ URL::asset('assets/chars/maintenances.js') }}"></script>
@endsection
@section('sub_titel')
    ...
    <div class="m-portlet m-portlet--tabs">
                                ...
                                <div class="m-dropdown__body">
                                    <div class="m-dropdown__content">
                                        <ul class="m-nav">
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_maintenance2',$type='Today')}}" >
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_maintenance2',$type='Yesterday')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Yesterday
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_maintenance2',$type='Last 7 Days')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last 7 Days
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link" href="{{route('report_maintenance2',$type='Last 30 Days')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last 30 Days
                                                    </span>
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link" href="{{route('report_maintenance2',$type='This Month')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        This Month
                                                    </span>
                                            ...
                                            <li class="m-nav__item ">
                                                <a class="m-nav__link" href="{{route('report_maintenance2',$type='Year')}}" >
                                                    <i class="m-nav__link-icon flaticon-clipboard"></i>
                                                    <span class="m-nav__link-text">
                                                        Last Year
                                                    </span>
                                        ...
                                        <ul class="m-nav">
                                            ...
                                            <li class="m-nav__item">
                                                <a class="m-nav__link"  href="{{route('report_maintenance')}}">
                                                    <i class="m-nav__link-icon flaticon-truck"  style="color: #716aca"></i>
        ...
        <div class="m-portlet__body">
            ...
            <span class="m--font-danger">
                <b>Note</b> This Reports For Maintenance Workers 
            ...
            @else
            <span class="m--font-danger">
                <b>Note</b> This Reports For All Maintenance Workers 
                <br>
            </span>
            @endif  
                    ...
                    <div class="m-portlet__body">
                        <div class="tab-content">
                                ...
                                <div class="col-md-12">
                                    <div class="m-widget16">
                                        <div class="row">
                                                ...
                                                <div class="m-widget16__body">
                                                    ...
                                                    <div class="m-widget16__item">
                                                        ...
                                                        <span class="m-widget16__price m--align-right m--font-accent">
                                                            ...
                                                            0%
                                                            @else
                                                            {{ROUND($active->count()*100/$countmaintenances->count())}}%
                                                            @endif
                                                        </span>
                                                    </div>
                                                    <!--end::widget item-->
                                                    ...
                                                    <div class="m-widget16__item">
                                                        <span class="m-widget16__date">
                                                            Non Active Maintenance Workers
                                                        </span>
                                                        <span class="m-widget16__price m--align-right m--font-danger">
                                                            @if($nonactive->count()==0)
                                                            0%
                                                            @else
                                                            {{ROUND($nonactive->count()*100/$countmaintenances->count())}}%
                                                            @endif
                                                        </span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                <script>
                                                    var $active_maintenances = {!! json_encode($active->count()) !!};
                                                    var $nonactive_maintenances = {!! json_encode($nonactive->count()) !!};
                                                    
                                                </script>
                                                <canvas id="maintenances"></canvas>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <table class="m-datatable" id="html_table" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        @if($maintenance->level==3)
                                            ...
                                            <td>
                                                    {{$maintenance->office->office_name}}
                                            </td>
                                            <td>
                                                {{$maintenance->phone_number}}
                                            </td>
                                            <td>
                                ...
                                <div class="row">
                                    <div class="col-lg-9">
                                        <div class="alert m-alert--default" role="alert">
                                            ...
                                            There Are No Maintenance Workers Currently
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="Chars">
                                <div class="row">
                                    <div class="col-md-6">
                                        <canvas id="maintenances2"></canvas>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="m_daterangepicker_modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form  action="{{route('report_maintenance2',$type='rang')}}"  class="m-form m-form--fit m-form--label-align-right">
