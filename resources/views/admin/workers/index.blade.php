            ...
            <div class="form-group m-form__group row align-items-center">
                <div class="col-md-12">
                    <div class="m-input-icon m-input-icon--left">
                        <input type="text" class="form-control m-input m-input--solid" placeholder="Search For Workers..." id="generalSearch"  >
...
<table class="m-datatable" id="html_table" width="100%">
    ...
    <tbody>
        ...
        @if($worker->level==3)
            ...
            <td>
                    <a href="{{route('Workers.edit',$worker->id)}}" class="btn btn-outline-accent m-btn m-btn--icon m-btn--icon-only m-btn--pill">
    ...
    <div class="col-lg-9">
        <div class="alert m-alert--default" role="alert">
            <strong>
             ...
             there are no workers currently
        </div>
    </div>
