						...
						<div class="m-login__signin">
                            ...
                            <div class="m-login__form m-form" >
								...
								<div class="m-login__form-action">
									<a href="{{ route('login') }}"  class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">
									 {{ __('Login') }}
									</a>
								</div>

								<div class="m-login__form-action">
									<a href="{{ route('register') }}"  class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air  m-login__btn">
									 {{ __('register') }}
									</a>
								</div>
							</div>
